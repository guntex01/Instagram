...
final class EditProfileViewController: UIViewController,  UITableViewDataSource{
    ...
    private func configureModel() {
        ...
        for label in sectionLabels {
            let model = EditProfileForModel(label: label, placehoder: "Enter \(label)...", value: nil)
    ...
    private func createTableHeaderView() -> UIView {
        ...
        profilePhotoButton.setBackgroundImage(UIImage(named: "person.circle"), for: .normal)
